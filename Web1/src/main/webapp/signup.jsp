...
<body>
	...
	<section>
		<form name="login" action="index.html" method="post">
			...
			<input type="radio" name="gender" value="m" id="woman"> <br>
			<br> 이메일<br>
			...
			<br> 관심사<br> IT<input type="checkbox" name="check"
				value="hobby1"> 보안<input type="checkbox" name="check"
				value="hobby2"> 웹<input type="checkbox" name="check"
				value="hobby3"> 서버<input type="checkbox" name="check"
				value="hobby4"> <br>
